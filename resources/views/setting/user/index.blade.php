          ...
          <div class="p-4 md:p-5 space-y-4">
            <form id="editUserForm" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="edit-name" type="text" placeholder="Name" name="name" required>
              </div>
              <div class="mb-4">
