    ...
    <div class="bg-white rounded-lg shadow-lg w-1/3 p-6">
      ...
      <form id="edit-client-form" method="POST" action="{{ route('admin.clients.update', $client->id ?? '') }}">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="edit-name" name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $client->name ?? '' }}" placeholder="Enter name" required>
        </div>

        <div class="mb-4">
          <label for="edit-age" class="block text-gray-700 text-sm font-bold mb-2">Client's Age:</label>
          <input type="number" id="edit-age" name="age" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $client->age ?? '' }}" placeholder="Enter age" required>
        </div>

        <div class="mb-4">
          <label for="edit-phone" class="block text-gray-700 text-sm font-bold mb-2">Client's Phone Number:</label>
          <input type="text" id="edit-phone" name="phone_number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $client->phone_number ?? '' }}" placeholder="Enter phone number" required>
        </div>
